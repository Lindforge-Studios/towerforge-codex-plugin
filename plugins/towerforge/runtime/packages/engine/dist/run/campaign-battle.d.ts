...
export type CampaignBattleFailureCode = "campaign_inactive" | "campaign_handoff_inactive" | "invalid_run" | "unknown_node" | "unknown_card" | "unknown_artifact" | "unknown_module" | "unknown_run_resource" | "invalid_run_resource" | "node_not_available" | "node_type_not_implemented" | "modifier_budget_exceeded" | "battle_context_mismatch" | "battle_not_victorious" | "run_capacity_exceeded" | "invalid_profile" | PlayerProfileFailureCode;
...
export declare function prepareCampaignBattle(run: CampaignRunV2, content: GameContentRegistry, nodeId: string): CampaignBattlePreparationResult;
export declare function settleCampaignBattleVictory(run: CampaignRunV2, profile: PlayerProfileV3, content: GameContentRegistry, nodeId: string, earnedStars: number, game: TowerDefenseGame): CampaignBattleSettlementResult;
