...
export declare const MECHANICS_MODULE_IDS: readonly ["combat", "reactions", "navigation", "elevation", "physics", "terraforming", "roguelite", "heroes", "logistics", "director", "quests", "scriptingDx", "multiplayer"];
...
export declare const IMPLEMENTED_MECHANICS_MODULE_IDS: readonly ["combat", "reactions", "navigation", "elevation", "physics", "terraforming", "roguelite", "heroes", "logistics", "director", "quests", "multiplayer"];
